...
from env import AWS_REGION, INDEX_RECORD_LIMIT, INDEX_REPORT_COUNT, ATHENA_QUERY_TIMEOUT, SL_LAMBDA, SL_DATASOURCE_MAP
...
def build_lambda_index(bedrock, s3_bucket = None, s3_key = None, delete_idx = False):
    ...
    for index, row in enumerate(list):
        ...
        try:
            ...
            add_index_document(security_lake_lambda_index_name, doc)
