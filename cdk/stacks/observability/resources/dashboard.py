...
from stacks.observability.constants import DashboardProps
...
class Dashboard(Construct):
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        dashboard = aws_cloudwatch.Dashboard(
            ...
            dashboard_name=DashboardProps.DASHBOARD_NAME
        )
        ...
        lambda_errors_widget = aws_cloudwatch.GraphWidget(
            ...
            left=[
                aws_cloudwatch.Metric(
                    ...
                    metric_name="Errors",
                    dimensions_map={"FunctionName": SearchSecurityLakeProps.LAMBDA_NAME},
                    statistic="Sum",
